/*
 * $Id: test_mxf_page_file.c,v 1.1 2008/02/18 10:18:45 philipn Exp $
 *
 * 
 *
...
int main(int argc, const char* argv[])
{
    ...
    CHECK(mxf_page_file_open_new(g_testFile, PAGE_SIZE, &mxfFile));
    ...
    CHECK(mxf_page_file_open_modify(g_testFile, PAGE_SIZE, &mxfFile));
    ...
    CHECK(mxf_page_file_open_read(g_testFile, &mxfFile));
    ...
    CHECK(mxf_page_file_open_new("pagetest_out__%d.mxf", PAGE_SIZE, &mxfFile));
